...
@WebServlet("/bbs/oncenter.do")
public class oncenterList extends HttpServlet {
	...
	protected void doAll(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("======00===count=========:"+count);
		...
		v = dao.getAllTheList(startRow , endRow);
		...
		RequestDispatcher dis = request.getRequestDispatcher("/bbs/oncenter.jsp");
